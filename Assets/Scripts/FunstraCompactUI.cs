...
namespace Funstra
{
    public sealed partial class FunstraGame
    {
        ...
        {
            Panel(24,24,310,94);
            Text("FUNSTRA / "+(DistrictEnabled?PortClock:"OLD PORT"),43,37,272,29,20,paper,FontStyle.Bold);
            Text(DistrictEnabled?Mathf.CeilToInt(District.health)+" HEALTH / "+(District.bleeding?"BLEEDING":"STABLE"):"A NIGHT IN OLD PORT",43,72,272,28,16,DistrictEnabled&&District.bleeding?CityArt.Red:CityArt.Mint,FontStyle.Bold);
